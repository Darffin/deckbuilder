...
public class MapController {
    ...
    public void loadChest(ActionEvent event) throws IOException {
        Button clickedButton = (Button) event.getSource();
        String nodeId = clickedButton.getId();
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/darffin/fxml/Chest.fxml"));
        fxmlLoader.setControllerFactory(context::getBean);
        Parent chest = fxmlLoader.load();
